...
func registerTools(server *mcp.Server, client *sdk.MentalitySkillTrainingSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "mentality-skill-training_list",
		Description: "List records from MentalitySkillTraining. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "mentality-skill-training_load",
		Description: "Load a single record from MentalitySkillTraining. " +
...
func runOp(client *sdk.MentalitySkillTrainingSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
