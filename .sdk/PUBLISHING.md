...
|---|---|---|
| `ts/` | @voxgig-sdk/mentality-skill-training-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/mentality-skill-training-sdk \
      --repository voxgig-sdk/mentality-skill-training-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/mentality-skill-training-sdk` shows it, and
`npm trust revoke @voxgig-sdk/mentality-skill-training-sdk --id=<id>` removes it.
