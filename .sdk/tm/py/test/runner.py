...
class MentalitySkillTrainingTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MentalitySkillTrainingTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MentalitySkillTrainingTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MentalitySkillTrainingTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
