...
// MentalitySkillTraining SDK utility type

class MentalitySkillTrainingUtility
{
    ...
    public static function copy(MentalitySkillTrainingUtility $src): MentalitySkillTrainingUtility
    {
        $u = new MentalitySkillTrainingUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
