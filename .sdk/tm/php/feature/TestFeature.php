...
// MentalitySkillTraining SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MentalitySkillTrainingTestFeature extends MentalitySkillTrainingBaseFeature
{
    ...
    public function init(MentalitySkillTrainingContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MentalitySkillTrainingContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MentalitySkillTrainingParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MentalitySkillTrainingContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MentalitySkillTrainingContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = MentalitySkillTrainingParam::call($ctx, $k);
