...
// MentalitySkillTraining SDK rbac feature
...
class MentalitySkillTrainingRbacFeature extends MentalitySkillTrainingBaseFeature
{
    ...
    private function _required(MentalitySkillTrainingContext $ctx): ?string
    {
    ...
    private function _reject(MentalitySkillTrainingContext $ctx, string $required): void
    {
    ...
    private function _track(MentalitySkillTrainingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
