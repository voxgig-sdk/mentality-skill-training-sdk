...
// MentalitySkillTraining SDK proxy feature
...
class MentalitySkillTrainingProxyFeature extends MentalitySkillTrainingBaseFeature
{
    ...
    public function init(MentalitySkillTrainingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MentalitySkillTrainingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
