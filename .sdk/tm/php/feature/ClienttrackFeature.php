...
// MentalitySkillTraining SDK clienttrack feature
...
class MentalitySkillTrainingClienttrackFeature extends MentalitySkillTrainingBaseFeature
{
    ...
    public function PostConstruct(MentalitySkillTrainingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MentalitySkillTraining-SDK';
