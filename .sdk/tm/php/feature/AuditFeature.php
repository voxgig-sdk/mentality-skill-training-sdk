...
// MentalitySkillTraining SDK audit feature
...
class MentalitySkillTrainingAuditFeature extends MentalitySkillTrainingBaseFeature
{
    ...
    private function _emit(MentalitySkillTrainingContext $ctx, string $outcome): void
    {
