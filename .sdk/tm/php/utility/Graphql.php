...
// MentalitySkillTraining SDK utility: graphql
//
...
class MentalitySkillTrainingGraphql
{
    ...
    // equivalent.
    public static function body(MentalitySkillTrainingContext $ctx): mixed
    {
    ...
    public static function errors(MentalitySkillTrainingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
