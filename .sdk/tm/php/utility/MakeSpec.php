...
// MentalitySkillTraining SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class MentalitySkillTrainingMakeSpec
{
    public static function call(MentalitySkillTrainingContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = MentalitySkillTrainingGraphql::CONTENT_TYPE;
        } else {
