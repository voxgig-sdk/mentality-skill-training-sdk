...
// MentalitySkillTraining SDK utility: make_options

class MentalitySkillTrainingMakeOptions
{
    ...
    public static function call(MentalitySkillTrainingContext $ctx): array
    {
        ...
        //
        // `MentalitySkillTrainingSchema::optspec()` is built from the model:
        ...
        $optspec = MentalitySkillTrainingSchema::optspec();
