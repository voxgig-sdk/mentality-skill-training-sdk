# MentalitySkillTraining PHP SDK

The PHP SDK for the MentalitySkillTraining API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Exercis(null)->list(null, null);
...
[$result, $err] = $client->MentalitySkillTraining(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── mentalityskilltraining_sdk.php          -- Main SDK class
...
The main class (`mentalityskilltraining_sdk.php`) exports the SDK class
