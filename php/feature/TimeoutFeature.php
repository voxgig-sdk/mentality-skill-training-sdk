...
// MentalitySkillTraining SDK timeout feature
...
class MentalitySkillTrainingTimeoutFeature extends MentalitySkillTrainingBaseFeature
{
    ...
    private function _with_timeout(MentalitySkillTrainingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MentalitySkillTrainingContext $_ctx, float $ms): void
    {
        $client = $this->client;
