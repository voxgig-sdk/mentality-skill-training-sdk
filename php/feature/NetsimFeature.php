...
// MentalitySkillTraining SDK netsim feature
...
class MentalitySkillTrainingNetsimFeature extends MentalitySkillTrainingBaseFeature
{
    ...
    private function _simulate(MentalitySkillTrainingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MentalitySkillTrainingContext $ctx, array $applied): void
    {
        $client = $this->client;
