...
// MentalitySkillTraining SDK ratelimit feature
...
class MentalitySkillTrainingRatelimitFeature extends MentalitySkillTrainingBaseFeature
{
    ...
    private function _acquire(MentalitySkillTrainingContext $ctx): void
    {
    ...
    private function _track(MentalitySkillTrainingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
