...
// MentalitySkillTraining SDK debug feature
...
class MentalitySkillTrainingDebugFeature extends MentalitySkillTrainingBaseFeature
{
    ...
    private function _finish(MentalitySkillTrainingContext $ctx, bool $ok): void
    {
