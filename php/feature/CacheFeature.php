...
// MentalitySkillTraining SDK cache feature
...
class MentalitySkillTrainingCacheFeature extends MentalitySkillTrainingBaseFeature
{
    ...
    private function _through(MentalitySkillTrainingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
