...
// MentalitySkillTraining SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MentalitySkillTrainingMakeRequest
{
    public static function call(MentalitySkillTrainingContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MentalitySkillTrainingResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MentalitySkillTrainingResponse($fetched);
        } else {
