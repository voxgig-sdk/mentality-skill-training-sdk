...
// MentalitySkillTraining SDK utility: fetcher

class MentalitySkillTrainingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MentalitySkillTrainingSDK/1.0)';
    ...
    public static function call(MentalitySkillTrainingContext $ctx, string $fullurl, array $fetchdef): array
    {
