...
class MentalitySkillTrainingSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = MentalitySkillTrainingHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = MentalitySkillTrainingHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!MentalitySkillTrainingFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, MentalitySkillTrainingFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return MentalitySkillTrainingUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = MentalitySkillTrainingHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = MentalitySkillTrainingHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = MentalitySkillTrainingHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new MentalitySkillTrainingError($op . "_allow",
                "MentalitySkillTrainingSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = MentalitySkillTrainingHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new MentalitySkillTrainingError("graphql_error",
                "MentalitySkillTrainingSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function TrainingProgram($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_training_program === null) {
                $this->_training_program = new TrainingProgramEntity($this, null);
            }
            return $this->_training_program;
        }
        return new TrainingProgramEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new MentalitySkillTrainingSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
