...
// MentalitySkillTraining SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MentalitySkillTrainingOmni::makeStructRunner(
    ...
    {
        return MentalitySkillTrainingOmni::objmodel(MentalitySkillTrainingOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return MentalitySkillTrainingOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return MentalitySkillTrainingOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MentalitySkillTrainingOmni::structfix($now, Struct::undef()))
                        !== json_encode(MentalitySkillTrainingOmni::structfix($val, Struct::undef()))) {
