...
class ExercisEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MENTALITYSKILLTRAINING_TEST_EXERCIS_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function exercis_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MENTALITYSKILLTRAINING_TEST_EXERCIS_ENTID");
