...
// MentalitySkillTraining SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MentalitySkillTrainingSDK::test)
...
{
    private const SDK_CLASS = 'MentalitySkillTrainingSDK';
    ...
    private const SDK_BASE = 'mentalityskilltraining_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../mentalityskilltraining_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
