...
class MentalitySkillTrainingTestRunner
{
    ...
    {
        $live = self::getenv('MENTALITYSKILLTRAINING_TEST_LIVE');
        $override = self::getenv('MENTALITYSKILLTRAINING_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MENTALITYSKILLTRAINING_TEST_EXPLAIN');
