...
// MentalitySkillTraining SDK pipeline test
//
...
{
    private static function utility(): MentalitySkillTrainingUtility
    {
        return new MentalitySkillTrainingUtility();
    }
    ...
    private static function ctx(array $over = []): MentalitySkillTrainingContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MentalitySkillTrainingContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MentalitySkillTrainingOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MentalitySkillTrainingError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MentalitySkillTrainingOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MentalitySkillTrainingMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MentalitySkillTrainingOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MentalitySkillTrainingMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MentalitySkillTrainingOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MentalitySkillTrainingMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MentalitySkillTrainingSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MentalitySkillTrainingMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MentalitySkillTrainingResponse([]),
            'result' => new MentalitySkillTrainingResult([]),
        ]);
        [, $err] = MentalitySkillTrainingMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MentalitySkillTrainingSpec([]),
            'response' => null,
            'result' => new MentalitySkillTrainingResult([]),
        ]);
        [, $err] = MentalitySkillTrainingMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MentalitySkillTrainingSpec(['step' => 's']),
            'response' => new MentalitySkillTrainingResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MentalitySkillTrainingResult([]),
        ]);
        [, $err] = MentalitySkillTrainingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MentalitySkillTrainingSpec(['step' => 's']),
            'response' => new MentalitySkillTrainingResponse(self::resp(200, ['v' => 1])),
            'result' => new MentalitySkillTrainingResult([]),
        ]);
        [, $err] = MentalitySkillTrainingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MentalitySkillTrainingSpec(['step' => 's']),
            'response' => new MentalitySkillTrainingResponse(self::resp(200, ['v' => 2])),
            'result' => new MentalitySkillTrainingResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MentalitySkillTrainingMakeResponse::call($ctx);
    ...
    {
        $preset = new MentalitySkillTrainingResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MentalitySkillTrainingSpec([]),
            'response' => new MentalitySkillTrainingResponse([]),
            'result' => new MentalitySkillTrainingResult([]),
        ...
        [$got, $err] = MentalitySkillTrainingMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MentalitySkillTrainingResult([])]);
        [, $err] = MentalitySkillTrainingMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MentalitySkillTrainingSpec([]), 'result' => null]);
        [, $err] = MentalitySkillTrainingMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MentalitySkillTrainingSpec(['step' => 's']),
            'result' => new MentalitySkillTrainingResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MentalitySkillTrainingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MentalitySkillTrainingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MentalitySkillTrainingSpec(['step' => 's']),
            'result' => new MentalitySkillTrainingResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MentalitySkillTrainingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MentalitySkillTrainingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MentalitySkillTrainingResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MentalitySkillTrainingSpec([]),
            'result' => new MentalitySkillTrainingResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MentalitySkillTrainingMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MentalitySkillTrainingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MentalitySkillTrainingError('boom', 'boom');
        $utility->fetcher = function (MentalitySkillTrainingContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MentalitySkillTrainingSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MentalitySkillTrainingMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MentalitySkillTrainingContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MentalitySkillTrainingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MentalitySkillTrainingResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MentalitySkillTrainingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MentalitySkillTrainingContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MentalitySkillTrainingSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MentalitySkillTrainingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MentalitySkillTrainingResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MentalitySkillTrainingSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MentalitySkillTrainingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MentalitySkillTrainingMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MentalitySkillTrainingMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MentalitySkillTrainingResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MentalitySkillTrainingDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MentalitySkillTrainingResult(['ok' => false])]);
        $this->expectException(MentalitySkillTrainingError::class);
        MentalitySkillTrainingDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MentalitySkillTrainingResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MentalitySkillTrainingMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MentalitySkillTrainingMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MentalitySkillTrainingBaseFeature();
        $b = new MentalitySkillTrainingBaseFeature();
        MentalitySkillTrainingFeatureAdd::call($ctx, $a);
        MentalitySkillTrainingFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MentalitySkillTrainingBaseFeature
    {
        $f = new MentalitySkillTrainingBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MentalitySkillTrainingFeatureAdd::call($ctx, self::named_feature('a'));
        MentalitySkillTrainingFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        MentalitySkillTrainingFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        MentalitySkillTrainingFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        MentalitySkillTrainingFeatureAdd::call($ctx, $replace);
        ...
        MentalitySkillTrainingFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MentalitySkillTrainingContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MentalitySkillTrainingSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MentalitySkillTrainingPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MentalitySkillTrainingPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MentalitySkillTrainingResponse(['headers' => null]),
            'result' => new MentalitySkillTrainingResult([]),
        ]);
        MentalitySkillTrainingResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MentalitySkillTrainingResultBody::call($ctx);
