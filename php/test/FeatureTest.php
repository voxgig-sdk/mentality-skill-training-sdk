...
// MentalitySkillTraining SDK feature test
//
...
class FtCtrl extends MentalitySkillTrainingControl
{
...
class FtClient
{
    ...
    private MentalitySkillTrainingUtility $utility;

    public function __construct(MentalitySkillTrainingUtility $utility, array $options)
    {
    ...
    public function get_utility(): MentalitySkillTrainingUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (MentalitySkillTrainingContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public MentalitySkillTrainingContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (MentalitySkillTrainingContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = MentalitySkillTrainingConfig::make_feature($name);
    ...
    private static function buildUrl(MentalitySkillTrainingSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof MentalitySkillTrainingError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new MentalitySkillTrainingResponse($fetched);
        }
    ...
    private function fail(MentalitySkillTrainingContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (MentalitySkillTrainingContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
