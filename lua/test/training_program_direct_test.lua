...
describe("TrainingProgramDirect", function()
  it("should direct-list-training_program", function()
    local setup = training_program_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-training_program", setup.live and "live" or "unit")
...
function training_program_direct_setup(mockres)
