...
local TrainingProgramEntity = {}
TrainingProgramEntity.__index = TrainingProgramEntity


function TrainingProgramEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TrainingProgramEntity)
  self._name = "training_program"
  self._client = client
...
function TrainingProgramEntity:get_name()
  return self._name
end


function TrainingProgramEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TrainingProgramEntity.new(self._client, opts)
end
...
function TrainingProgramEntity:mark_deleted()
  self._deleted = true
end


function TrainingProgramEntity:deleted()
  return true == self._deleted
end


function TrainingProgramEntity:data_set(args)
  if args ~= nil then
...
function TrainingProgramEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TrainingProgramEntity:match_set(args)
  if args ~= nil then
...
function TrainingProgramEntity:match_get()
...
function TrainingProgramEntity:stream(action, args, callopts)
...
function TrainingProgramEntity:_run_op(ctx, post_done)
  local utility = self._utility
