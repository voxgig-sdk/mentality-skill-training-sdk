...
require("mentality-skill-training_types")
...
local MentalitySkillTrainingSDK = {}
MentalitySkillTrainingSDK.__index = MentalitySkillTrainingSDK
...
MentalitySkillTrainingSDK._make_feature = _make_feature


function MentalitySkillTrainingSDK.new(options)
  local self = setmetatable({}, MentalitySkillTrainingSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function MentalitySkillTrainingSDK:options_map()
...
function MentalitySkillTrainingSDK:get_utility()
  return Utility.copy(self._utility)
end


function MentalitySkillTrainingSDK:get_root_ctx()
  return self._rootctx
end


function MentalitySkillTrainingSDK:prepare(fetchargs)
...
function MentalitySkillTrainingSDK:direct(fetchargs)
...
function MentalitySkillTrainingSDK:_op_allowed(op)
  local allow = vs.getpath(self.options, "allow.op")
  return type(allow) == "string" and allow:find(op, 1, true) ~= nil
end


function MentalitySkillTrainingSDK:_op_denied(op)
  local allow = vs.getpath(self.options, "allow.op")
  if type(allow) ~= "string" then allow = "" end
  return {
    ok = false,
    err = "MentalitySkillTrainingSDK: " .. op .. ": operation not allowed by" ..
...
-- by passing it.
function MentalitySkillTrainingSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function MentalitySkillTrainingSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "MentalitySkillTrainingSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function MentalitySkillTrainingSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = MentalitySkillTrainingSDK.new(sdkopts)
  sdk.mode = "test"
...
return MentalitySkillTrainingSDK
