...
const testSeed = `map[string]any{"entity": map[string]any{"exercis": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "training_program": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
