...
type MentalitySkillTrainingSDK struct {
	Mode     string
...
func (sdk *MentalitySkillTrainingSDK) OptionsMap() map[string]any {
...
func (sdk *MentalitySkillTrainingSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MentalitySkillTrainingSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MentalitySkillTrainingSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MentalitySkillTrainingSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MentalitySkillTrainingSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MentalitySkillTrainingSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MentalitySkillTrainingSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MentalitySkillTrainingSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MentalitySkillTrainingSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MentalitySkillTrainingSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *MentalitySkillTrainingSDK {
	...
	sdk := NewMentalitySkillTrainingSDK(sdkopts)
	sdk.Mode = "test"
