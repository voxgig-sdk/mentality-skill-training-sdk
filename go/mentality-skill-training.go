...
// instead of `sdk.NewMentalitySkillTrainingSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *MentalitySkillTrainingSDK  { return NewMentalitySkillTrainingSDK(nil) }
func Test() *MentalitySkillTrainingSDK { return TestSDK(nil, nil) }
