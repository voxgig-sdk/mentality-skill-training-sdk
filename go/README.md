...
The Golang SDK for the MentalitySkillTraining API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/mentality-skill-training-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/mentality-skill-training-sdk=../path/to/github.com/voxgig-sdk/mentality-skill-training-sdk
```
...
```go
    result, err := client.Exercis(nil).List(nil, nil)
    if err != nil {
        panic(err)
    }
...
| `Exercis` | `(data map[string]any) MentalitySkillTrainingEntity` | Create a Exercis entity instance. |
...
```
github.com/voxgig-sdk/mentality-skill-training-sdk/
...
The root package (`github.com/voxgig-sdk/mentality-skill-training-sdk`) re-exports everything needed
