...
func NewTrainingProgramEntity(client *core.MentalitySkillTrainingSDK, entopts map[string]any) *TrainingProgramEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TrainingProgramEntity) GetName() string { return e.name }
...
func (e *TrainingProgramEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TrainingProgramEntity) Deleted() bool {
	return e.deleted
}


func (e *TrainingProgramEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTrainingProgramEntity(e.client, opts)
}

func (e *TrainingProgramEntity) Data(args ...any) any {
...
func (e *TrainingProgramEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TrainingProgram; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TrainingProgramEntity) DataTyped(data ...TrainingProgram) TrainingProgram {
	if len(data) > 0 {
		return typedFrom[TrainingProgram](e.Data(asMap(data[0])))
	}
	return typedFrom[TrainingProgram](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TrainingProgram (all fields
// optional at the wire level).
func (e *TrainingProgramEntity) MatchTyped(match ...TrainingProgram) TrainingProgram {
	if len(match) > 0 {
		return typedFrom[TrainingProgram](e.Match(asMap(match[0])))
	}
	return typedFrom[TrainingProgram](e.Match())
}
...
func (e *TrainingProgramEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TrainingProgramEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TrainingProgramEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TrainingProgramListMatch and returns []TrainingProgram. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TrainingProgramEntity) ListTyped(reqmatch TrainingProgramListMatch, ctrl map[string]any) ([]TrainingProgram, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TrainingProgram](res), nil
}



func (e *TrainingProgramEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TrainingProgramEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TrainingProgramEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TrainingProgramEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
