# MentalitySkillTraining SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MentalitySkillTrainingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MentalitySkillTrainingSDK(...) and MentalitySkillTrainingSDK.test(...) become
#      MentalitySkillTrainingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mentalityskilltraining_sdk"
_SDK_CLASS = "MentalitySkillTrainingSDK"
