...
from mentalityskilltraining_sdk.core.response import MentalitySkillTrainingResponse
from mentalityskilltraining_sdk.core.operation import MentalitySkillTrainingOperation
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return MentalitySkillTrainingError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except MentalitySkillTrainingError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = MentalitySkillTrainingResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = MentalitySkillTrainingSDK.test(None, None)
        ...
        class TestInitFeature(MentalitySkillTrainingBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MentalitySkillTrainingBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = MentalitySkillTrainingSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = MentalitySkillTrainingSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MentalitySkillTrainingSpec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MentalitySkillTrainingSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MentalitySkillTrainingSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = MentalitySkillTrainingOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MentalitySkillTrainingSDK.test(None, setup_opts)
