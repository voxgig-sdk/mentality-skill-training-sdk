...
from mentalityskilltraining_sdk.core.helpers import get_ctx_prop, to_map
...
class MentalitySkillTrainingContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MentalitySkillTrainingControl()
        ...
        if isinstance(sp, MentalitySkillTrainingSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MentalitySkillTrainingResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MentalitySkillTrainingResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MentalitySkillTrainingOperation({})
    ...
    def make_error(self, code, msg):
        return MentalitySkillTrainingError(code, msg, self)
