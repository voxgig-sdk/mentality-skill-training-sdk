...
from mentalityskilltraining_sdk.utility import register

# Load features
from mentalityskilltraining_sdk.feature.base_feature import MentalitySkillTrainingBaseFeature
from mentalityskilltraining_sdk.features import _has_feature, _make_feature
...
class MentalitySkillTrainingSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MentalitySkillTrainingUtility()
    ...
    def get_utility(self):
        return MentalitySkillTrainingUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MentalitySkillTrainingSDK: graphql: " + str(msg))
            res["graphql"] = errors
