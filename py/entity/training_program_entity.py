...
from mentalityskilltraining_types import (
    TrainingProgram,
...
class TrainingProgramEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TrainingProgramEntity(self._client, opts)
    ...
    def data_get(self) -> TrainingProgram:
    ...
    def match_get(self) -> TrainingProgram:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TrainingProgram]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TrainingProgram().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
