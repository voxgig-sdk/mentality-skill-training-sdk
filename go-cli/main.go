// Command MentalitySkillTraining-cli is a CLI + REPL for the MentalitySkillTraining SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      MENTALITY_SKILL_TRAINING_APIKEY (api key), MENTALITY_SKILL_TRAINING_BASE (base url override)")
