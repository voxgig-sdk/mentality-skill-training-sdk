...
AQL-driven CLI and REPL for the MentalitySkillTraining SDK. Positional arguments are
...
```sh
go build -o mentality-skill-training-cli ./...
```
...
./mentality-skill-training-cli load 1 exercis
./mentality-skill-training-cli load '{id:1}' exercis
