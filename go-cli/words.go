...
func registerSDKWords(r *eng.Registry, client *sdk.MentalitySkillTrainingSDK) {
...
func runOp(client *sdk.MentalitySkillTrainingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
