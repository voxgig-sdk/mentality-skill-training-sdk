# MentalitySkillTraining SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # MentalitySkillTrainingSDK.new, not MentalitySkillTrainingSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    MentalitySkillTrainingSDK.new(opts)
  end
