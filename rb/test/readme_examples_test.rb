...
#      offline in seeded test mode (MentalitySkillTrainingSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MentalitySkillTraining_sdk.rb")
  SDK_CLASS = "MentalitySkillTrainingSDK"
  ...
  SDK_BASE = "MentalitySkillTraining_sdk"
