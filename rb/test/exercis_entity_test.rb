...
class ExercisEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MENTALITYSKILLTRAINING_TEST_EXERCIS_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def exercis_basic_setup(extra)
  ...
  entid_env_raw = ENV["MENTALITYSKILLTRAINING_TEST_EXERCIS_ENTID"]
