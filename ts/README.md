# MentalitySkillTraining TypeScript SDK

The TypeScript SDK for the MentalitySkillTraining API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| Method | Returns | Description |
| --- | --- | --- |
| `MentalitySkillTrainingSDK.test(testopts?, sdkopts?)` | `MentalitySkillTrainingSDK` | Create a test-mode client. |
...
| `client` | `client(): MentalitySkillTrainingSDK` | Return the parent SDK client. |
...
├── src/
│   ├── MentalitySkillTrainingSDK.ts        # Main SDK class
