...
const MentalitySkillTrainingError_1 = require("./MentalitySkillTrainingError");
...
class Context {
    ...
    error(code, msg) {
        return new MentalitySkillTrainingError_1.MentalitySkillTrainingError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
