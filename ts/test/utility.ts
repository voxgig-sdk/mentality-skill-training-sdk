...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.MENTALITYSKILLTRAINING_TEST_LIVE ||
    'TRUE' === process.env.MENTALITYSKILLTRAINING_TEST_OVERRIDE
  ) {
  ...
  m.MENTALITYSKILLTRAINING_TEST_EXPLAIN = process.env.MENTALITYSKILLTRAINING_TEST_EXPLAIN || m.MENTALITYSKILLTRAINING_TEST_EXPLAIN
