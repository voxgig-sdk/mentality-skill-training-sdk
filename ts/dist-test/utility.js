...
function envOverride(m) {
    if ('TRUE' === process.env.MENTALITY_SKILL_TRAINING_TEST_LIVE ||
        'TRUE' === process.env.MENTALITY_SKILL_TRAINING_TEST_OVERRIDE) {
    ...
    m.MENTALITY_SKILL_TRAINING_TEST_EXPLAIN = process.env.MENTALITY_SKILL_TRAINING_TEST_EXPLAIN || m.MENTALITY_SKILL_TRAINING_TEST_EXPLAIN;
    return m;
}
