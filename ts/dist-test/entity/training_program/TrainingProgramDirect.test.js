...
(0, node_test_1.describe)('TrainingProgramDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MentalitySkillTrainingSDK({
    ...
    (0, node_test_1.test)('direct-list-training_program', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-training_program', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.MENTALITY_SKILL_TRAINING_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'MENTALITY_SKILL_TRAINING_TEST_TRAINING_PROGRAM_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['MENTALITY_SKILL_TRAINING_TEST_TRAINING_PROGRAM_ENTID'];
    ...
    const client = new __1.MentalitySkillTrainingSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TrainingProgramDirect.test.js.map